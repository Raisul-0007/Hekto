                      ...
                      <div className=" bg-white border border-[#f1efef] transition-all duration-300 group-hover:scale-[1.02] rounded-2xl">
                        <div className="w-full relative">
                          <img
                            ...
                            alt={item.id}
                          />
                          <p className="absolute top-0 right-0 flex items-center justify-center rounded-bl-md rounded-tr-2xl h-10 w-15 bg-[#ff0073] text-white text-[12px] font-bold">
                        ...
                        <div className="bg-white py-5 px-3 group-hover:bg-[#2f1ac4] ease-in-out duration-400 rounded-b-2xl">
                          <div className="flex items-center justify-between ">
                            <h4 className="text-lg font-semibold text-center text-[#ff0073] group-hover:text-white ease-in-out duration-400">
                          ...
                          <div className="flex justify-between">
                            <h4 className="text-gray-600 group-hover:text-white ease-in-out duration-400">
                              {item.category}
                            </h4>
                    ...
                    <div className=" group ">
                      <div className="flex justify-between gap-3 group-hover:bg-[#2f1ac4] bg-white border border-[#f1efef] transition-all duration-300 group-hover:scale-[1.02] rounded-2xl">
                        ...
                        <div className="w-2/4 py-4">
                          ...
                          <p className="py-3 group-hover:text-white ease-in-out duration-400">
                            {item.category}
                          </p>
                        </div>
